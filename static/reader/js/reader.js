...
EPUBJS.Reader = function(bookPath, _options) {
  ...
  book.on("downloadProgress", function(percentage) {
    reader.ReaderController.updateLoader(percentage);
  });
...
EPUBJS.reader.ReaderController = function(book) {
	...
	var updateLoader = function(s) {
    $loaderPercent.html(Math.round(s * 100) + "%");
	};
